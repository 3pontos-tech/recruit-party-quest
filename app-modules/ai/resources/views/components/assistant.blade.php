{{--
    ...
    see https://github.com/canyongbs/He4rt/blob/main/LICENSE.
    ...
    @if ($this->isConsented && $this->thread)
                ...
                <template x-if="$wire.folders.length">
                    ...
                    >
                        <template x-for="folder in $wire.folders" :key="folder.id">
                            ...
                            >
                                <span
                                    class="group flex w-full cursor-move items-center rounded-lg px-2 transition duration-75 outline-none hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-white/5 dark:focus:bg-white/5"
                                >
                                    <x-filament::icon-button
                                        class="flex-shrink-0"
                                    ...
                                    <div
                                        class="group flex w-full cursor-pointer items-center gap-x-1 rounded-lg px-2 transition duration-75 outline-none focus:bg-gray-100 dark:focus:bg-white/5"
                                    >
                                        <div
        ...
        >
            ...
            >
                ...
                >
                    <div class="bg-danger-100 dark:bg-danger-900 px-4 py-2" x-cloak x-show="error">
                        <span x-text="error"></span>

                        <span x-show="! (isRetryable || isRateLimited)">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="flex justify-between empty:hidden lg:block">
                                                <div
                                                    class="visible mt-2 flex justify-center gap-2 self-end text-gray-400 md:gap-3 lg:absolute lg:top-0 lg:right-0 lg:mt-0 lg:translate-x-full lg:gap-1 lg:self-center lg:pl-2"
                                                    x-data="{
                                                        messageCopied: false,
    ...
    @elseif (! $this->isConsented)
        <div x-init="$nextTick(() => $dispatch('open-modal', { id: 'consent-agreement' }))">
            ...
            >
                ...
                <x-filament::section>
                    <div class="prose dark:prose-invert max-w-none text-left text-[.7rem] leading-4">
