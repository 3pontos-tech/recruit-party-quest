...
return [
    ...
    'export' => [
        'action' => [
            ...
            'modal_heading' => 'Exportar candidatos inscritos',
            'modal_description' => 'Escolha as colunas que devem ir para a planilha. O arquivo é gerado em segundo plano e você será notificado com o link de download quando ficar pronto.',
            'file_name' => 'candidatos',
        ],
        'columns' => [
            ...
            'total_experience' => 'Tempo Total de Experiência',
            'current_position' => 'Cargo Mais Recente',
            'location' => 'Localização',
            'expected_salary' => 'Pretensão Salarial',
            'availability_date' => 'Disponível a Partir De',
            'work_preference' => 'Preferência de Trabalho',
            'skills' => 'Habilidades',
            'education' => 'Formação',
        ...
        'work_preference' => [
            ...
            'relocate' => 'Disposto a mudar de cidade',
        ],
        'notifications' => [
            'completed' => [
                'body' => 'Sua exportação de candidatos está pronta: :count linhas exportadas.',
                'failed' => ':count linhas falharam na exportação.',
            ],
        ],
    ],
];
