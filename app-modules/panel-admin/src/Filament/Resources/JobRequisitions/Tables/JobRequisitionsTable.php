...
namespace He4rt\Admin\Filament\Resources\JobRequisitions\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('salary_range')
                    ...
                    ->state(fn ($record): string => $record->salary_range_min && $record->salary_range_max
                        ? number_format($record->salary_range_min).' - '.number_format($record->salary_range_max).' '.$record->salary_currency
                        : '-')
                    ->toggleable(),
