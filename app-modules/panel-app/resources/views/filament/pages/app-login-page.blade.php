...
<div {{ $attributes->class(['fi-simple-page']) }}>
    ...
    <div class="fi-simple-page-content grid-cols-1! gap-x-28! overflow-hidden p-1 lg:grid-cols-2!">
        <div class="self-end lg:pt-100">
            <div
                class="absolute top-0 left-0 hidden shrink-0 -translate-x-1/3 -translate-y-1/3 items-center justify-center lg:flex"
            >
                <img
            ...
            <div class="relative z-10 flex flex-col gap-4">
                ...
                <x-he4rt::heading class="hidden lg:block">Construa sua carreira com a 3 pontos</x-he4rt::heading>
