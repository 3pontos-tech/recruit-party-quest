<div class="flex flex-col gap-16">
    <div class="flex flex-col items-center gap-8 sm:flex-row sm:justify-between">
        ...
        <div class="flex items-center gap-8">
            ...
            <x-he4rt::button icon:trailing="heroicon-o-chevron-down" variant="outline">Tipo de vaga</x-he4rt::button>
        ...
        <x-he4rt::card class="group">
            <x-slot:header class="gap-4">
                ...
                <div class="flex flex-1 flex-col gap-0.5">
                    ...
                    <x-he4rt::text class="group-hover:text-text-high transition duration-500">3 Pontos</x-he4rt::text>
                </div>
