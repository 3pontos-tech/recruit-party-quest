...
return [
    ...
    'pipeline' => [
        ...
        'withdrawn_title' => 'Candidatura Encerrada',
        'withdrawn_message' => 'Você desistiu deste processo seletivo.',
        'withdrawn_on' => 'Desistiu em :date',
        'declined_title' => 'Proposta Recusada',
        'declined_message' => 'Você recusou a proposta para esta vaga.',
        'declined_on' => 'Recusada em :date',
        'view_details' => 'Ver detalhes do progresso',
        'duration_days' => '{0} mesmo dia|{1} :count dia|[2,*] :count dias',
        'screening_questions' => '{0} Sem perguntas de triagem|{1} :count pergunta de triagem|[2,*] :count perguntas de triagem',
        'stage_detail' => [
            'title' => 'Detalhes da etapa',
            'current_stage' => 'Etapa atual',
            'timeline' => 'Linha do tempo desta candidatura',
            'stage_sub' => 'etapa',
            'interviewers' => 'Entrevistadores',
            'evaluations' => 'Avaliações desta etapa',
            'next_stage' => 'Próxima etapa: :name',
            'previous' => 'Anterior',
            'next' => 'Próximo',
            'empty_future' => 'Esta etapa ainda não foi alcançada pelo candidato',
            'empty_notes' => 'Sem movimentações registradas nesta etapa',
